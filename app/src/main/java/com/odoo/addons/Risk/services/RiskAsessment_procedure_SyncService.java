...
public class RiskAsessment_procedure_SyncService extends OSyncService {
    public static final String TAG = RiskAsessment_procedure_SyncService.class.getSimpleName();
