...
public class acilir_liste_modul extends BaseExpandableListAdapter {
	...
	public acilir_liste_modul(Context context, List<String> list_parent, HashMap<String, List<String>> list_child)
	{
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if(view == null)
		{
			...
			view = inflater.inflate(R.layout.risk_assesment_acilir_menu_header,null);
		}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		{
			inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			view = inflater.inflate(R.layout.risk_assesment_acilir_menu_child, null);
		}
		if(getGroup(groupPosition).toString().equals("Action"))
		{
			//view.setBackgroundColor(Color.BLUE);
		}
		else if(getGroup(groupPosition).toString().equals("Duplicate"))
		{
			//view.setBackgroundColor(Color.BLUE);
		}
