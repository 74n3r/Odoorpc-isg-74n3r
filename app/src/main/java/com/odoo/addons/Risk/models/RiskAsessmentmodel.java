...
public class RiskAsessmentmodel extends OModel {
    ...
    OColumn partner_id = new OColumn("partner_id ", RiskAsessmentmodel.class, OColumn.RelationType.ManyToOne);
    OColumn assesment_method = new OColumn("assesment_method ", RiskAsessmentmodel.class, OColumn.RelationType.ManyToOne);
    OColumn procedure_id = new OColumn("procedure_id", OInteger.class);
